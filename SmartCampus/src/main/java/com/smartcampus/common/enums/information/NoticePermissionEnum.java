...
@Getter
@AllArgsConstructor
public enum NoticePermissionEnum {
     ...
     * 根据code获取枚举
     */
    public static NoticePermissionEnum getByCode(Integer code) {
        for (NoticePermissionEnum permission : values()) {
     ...
     * 根据key获取枚举
     */
    public static NoticePermissionEnum getByKey(String key) {
        for (NoticePermissionEnum permission : values()) {
